...
In the "Search" in folder you can type in the folder's name to find it. There is also a "Clear" button that clears the field. If the folder exists then it is shown and you can select it in order to view the foder files.
